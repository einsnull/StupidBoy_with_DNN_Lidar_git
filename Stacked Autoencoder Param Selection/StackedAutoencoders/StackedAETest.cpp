...
int main()
{
	...
	double lambdaVec[5] = {0.1,0.01,0.001,0.0001,0.00001};
	for(int i = 0; i < 5; i++)
	{
		lambda[3] = lambdaVec[i];

		char str[300];
		sprintf_s(str,"lambda: %lf",lambdaVec[i]);
		...
		printToFile("LogFile.txt",str);
		sprintf_s(str,"Dist on testset before fine tuning: %lf",calcDist(testLabels,pred1));
		printToFile("LogFile.txt",str);
		sprintf_s(str,"SlackAccurancy on testset before fine tuning: %lf",slackAccurancy(testLabels,pred1));
		printToFile("LogFile.txt",str);
		...
		printToFile("LogFile.txt",str);
		sprintf_s(str,"Dist on trainingset before fine tuning: %lf",calcDist(pred4,trainingLabels));
		printToFile("LogFile.txt",str);
		sprintf_s(str,"SlackAccurancy on trainingset before fine tuning: %lf",slackAccurancy(pred4,trainingLabels));
		printToFile("LogFile.txt",str);
		...
		printToFile("LogFile.txt",str);
		sprintf_s(str,"Dist on testset after fine tuning: %lf",calcDist(pred2,testLabels));
		printToFile("LogFile.txt",str);
		sprintf_s(str,"SlackAccurancy on testset after fine tuning: %lf",slackAccurancy(pred2,testLabels));
		printToFile("LogFile.txt",str);
		...
		printToFile("LogFile.txt",str);
		sprintf_s(str,"Dist on trainingset after fine tuning: %lf",calcDist(pred3,trainingLabels));
		printToFile("LogFile.txt",str);
		sprintf_s(str,"SlackAccurancy on trainingset after fine tuning: %lf",slackAccurancy(pred3,trainingLabels));
		printToFile("LogFile.txt",str);
